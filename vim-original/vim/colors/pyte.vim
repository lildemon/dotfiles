...
if version >= 700
  ...
  hi TabLineSel guifg=black guibg=#f0f0f0 gui=italic,NONE
...
hi Error      guifg=red guibg=white gui=NONE,underline
hi Todo       guifg=#a0b0c0 guibg=NONE gui=italic,NONE,underline
